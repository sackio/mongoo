...
module.exports = function(schema, options){
  ...
  //convert array to an object based on id
  schema.method('arrayToObject', function(options){
    var o = options || {}
      , self = this;
    ...
    o.paths = o.paths || Belt.toArray(o.path);
    var obj = Belt.set(self, o.obj_path, Belt.get(self, o.obj_path) || {});
    _.each(o.paths, function(p){
      return _.each(Belt.get(self, p) || [], function(d){
        var key = Belt.cast(Belt.get(d, o.el_path), 'string');
        obj[key] = d;
        return;
      });
    });
