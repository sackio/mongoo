...
module.exports['account'] = function(schema, options){
  ...
  schema.method('update_payment_method', function(token, options, callback){
    var b = Belt.argulint(arguments)
      , self = this;
    b.o = _.defaults(b.o, {
    ...
    return Async.waterfall([
      function(cb){
        return a.o.paid_api.update_payment_method(token, b.o, Belt.cw(cb, 0));
      }
    ], function(err){
      self.markModified(a.o.path);
